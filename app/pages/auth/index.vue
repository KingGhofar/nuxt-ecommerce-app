...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 p-4 sm:p-6 md:p-10">
    <div class="w-full max-w-[1130px] md:h-[714px] rounded-[32px] overflow-hidden shadow-2xl flex flex-col md:flex-row">
      ...
      <div class="w-full md:w-1/2 bg-white flex flex-col items-center justify-center px-6 sm:px-10 md:px-14 py-10 md:py-0">
        <!-- Logo -->
...
<style scoped>
/* Optional: tambahkan styling untuk memastikan container utama responsif */
